...
CREATE TABLE IF NOT EXISTS `account` (
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT 'id主键',
  `card_id` varchar(50) NOT NULL COMMENT '关联卡片ID，从哪来',
  `reversed_id` varchar(50) DEFAULT NULL COMMENT '冲正流水ID，指向被冲正的原流水',
...
CREATE TABLE IF NOT EXISTS `account_transfer` (
  `id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '转账ID',
  `user_id` varchar(50) NOT NULL COMMENT '用户ID',
