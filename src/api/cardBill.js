...
// 创建账单
router.post('/', createValidator(CardRules.createBill), cardBillController.create);

// 更新账单
router.put('/:id', createValidator(CardRules.updateBill), cardBillController.update);
